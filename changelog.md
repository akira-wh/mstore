- **`3.06`**  Улучшена система переключения вида модификаторами.

- **`3.05`**  Защита от переполнения. Убран лишний код.

- **`3.04`**  Улучшены тексты.

- **`3.03`**  Изменены некоторые изображения.
